...
async def help_command(message: Message):
    await message.answer("Всього є 4 основних команди: /take_picture, /fill_bowl, /calibrate_bowl, /calibrate_filling."
                         ...
                         "буде насипана максимальна відкалібрована кількість корму, або ж з параметром <i>-amount</i>. " 
                         ...
                         "\n\nКоманда /take_picture схожа за синтаксисом до попередньої. Доcтупні параметри: <i>-rotate, "
                         "-text, -brightness, -text_size, -text_color, -text_background, -effect, -exposure_mode, "
                         "-awb_mode, -res_x, -res_y</i>. Значення -text параметра може бути неперервана пробілами стрічка"
                         "(приклад_неперервної_стрічки), або, якщо в тексті є пробіли, його варто обгорнути в подвійні лапки. "
                         "Колір тексту та його фону має бути заданий словесно, наприклад red і тд. Стандартні "
                         "значення <i>-rotate</i>: 0, 90, 180, 270, 360; <i>-brightness</i>: 0-100(за замовчуванням 50); <i>-text_size</i>: "
                         ...
                         '\n\nЗагальна схема використання команд з параметрами: /command -[parameter] [value], наприклад, /take_picture -rotate 180 -text "Text on the picture" -text_size 87',
                         parse_mode='html',
